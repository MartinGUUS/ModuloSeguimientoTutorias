...
<div class="content">
    ...
    <div class="grid-container">
        ...
        <div class="msj-list">
            <table border=".5">
                <%
                    String idMatricula = (String) request.getSession().getAttribute("matriculaAlumno");

                    MensajesDAO mensajesDAO = new MensajesDAO();
                    List<Mensajes> listMensajes = mensajesDAO.selectMensajesPorAlumno(idMatricula);
                    ...
                    for (Mensajes mensaje : listMensajes) {
                        ...
                        String fechaFormateada = dateFormat.format(mensaje.getFecha());
                %>
                <tr>
                    <td>
                        <a href="#"
                           onclick="showMessageDetails('<%= nombreCompleto %>', '<%=mensaje.getAsunto()%>', '<%=fechaFormateada %>', '<%=mensaje.getMensaje()%>')">
